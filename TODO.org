...
*** TODO CL getting started Guide
*** TODO API documentation
*** TODO Web number-guessing game
...
* TODO the documentation should mention that primitives
...
* TODO ClGettingStarted.md uses shovel-vm:serialize-vm-state
