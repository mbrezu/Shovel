...
* TODO C#
** TODO check that stack overflows are handled correctly
   (the stack grows)
** TODO implement vm state serialization
** TODO port documentation
** TODO optimizations
*** TODO print the assembled code correctly (add numeric labels)
*** DONE implement the Lset/Pop/Lget peep-hole optmization
*** DONE implement jump propagation
**** TODO verify that it works for && AND ||
*** TODO finish converting the primitives to instructions
