...
* TODO results of string slice or indexing should be strings
* TODO it should be possible to assign strings of length 1 to string indices
* TODO add 'upper' and 'lower' primitives for strings
