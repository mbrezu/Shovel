...
** TODO offer a way to specify how expensive user-primitives are
   in terms of the execution quota
** TODO Gaaaah must write a garbage collector anyway - 
...
* TODO better use of #-/#+ to eliminate real-tests.lisp
